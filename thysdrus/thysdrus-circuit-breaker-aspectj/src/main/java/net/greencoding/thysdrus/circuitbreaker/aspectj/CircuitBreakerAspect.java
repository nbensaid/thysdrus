...
public class CircuitBreakerAspect {
	...
	private AnnotationDiscoverer annotationDiscoverer = new CircuitBreakerAnnotationDiscoverer();
	...
	@Around(POINTCUT)
	public Object breakCircuit(final ProceedingJoinPoint pjp, final MonitoredByCircuitBreaker annotation) throws Throwable {
		
		String circuitBreakerKey = getCircuitBreakerKey(pjp.getSignature().toLongString(), annotation);
	...
	private String getCircuitBreakerKey(final String methodSignature, final MonitoredByCircuitBreaker cbAnnotation) {
		return  cbAnnotation.groupId().isEmpty() ? methodSignature : cbAnnotation.groupId();
	}
